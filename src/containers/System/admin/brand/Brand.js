...
import { saveBrand, getAllBrand, deleteBrand } from "../../../../services/userService";
            ...
            <div className="row">
              <div className="col-md-4">
                ...
                <div className="mb-3">
                  ...
                  <input type="file" name="image" className="form-control" onChange={(event) => this.handleGetFile(event)} />
                </div>
                <div className="mb-3">
                  <label>
                    <strong>Trạng thái</strong>
                  </label>
                  <select name="status" className="form-control" onChange={(event) => this.handleOnChange(event, "status")}>
                      ...
                      return (
                        <tbody key={index}>
                          <tr className="datarow">
                            ...
                            <td>
                              <img className="img-fluid" src={item.image} alt="category.jpg" />
                            </td>
                            <td>
                              <div className="name">
                                <a> {item.name} </a>
                              ...
                              <div className="function_style">
                                ...
                                <Link to={`/system/brand/brand-edit`} className="px-1 text-primary" s>
                                  <i className="fa fa-edit"></i>
                                </Link>

                                <Link to={`/system/brand/brand-show`} className="px-1 text-info" s>
