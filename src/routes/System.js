          ...
          <section className="hdl-content">
            <div className="container-fluid">
              <div className="row">
                ...
                <Switch>
                  {/* //?Manage Product */}
                  <Route path={"/system/product/"} component={userIsAuthenticated(ProductRoute)} />
                  {/* //?Manage category */}
                  <Route path={"/system/category"} component={userIsAuthenticated(CategoryRoute)} />
                  <Route path="/system/user-redux" component={ImportProduct} />
                  {/* //?Manage brand */}
                  <Route path={"/system/brand"} component={userIsAuthenticated(BrandRoute)} />
                  <Route path="/system/manage-promotion" component={Promotion} /> {/* //?Manage page */}
                  <Route path={"/system/page"} component={userIsAuthenticated(PageRoute)} />
                  {/* //?Manage topic */}
                  <Route path={"/system/topic"} component={userIsAuthenticated(TopicRoute)} />
                  {/* //?Manage Post */}
                  <Route path={"/system/post"} component={userIsAuthenticated(PostRoute)} />
                  <Route path="/system/contract" component={ManageContract} />
                  <Route path="/system/contract-reply" component={ContractReply} />
                  {/* //?manager order */}
                  ...
                  {/* //?manager customer */}
                  <Route path={"/system/customer"} component={userIsAuthenticated(CustomerRouter)} />
                  {/* //?manager menu */}
                  <Route path={"/system/menu"} component={userIsAuthenticated(MenuRoute)} />
                  {/* //?manager banner */}
                  <Route path={"/system/banner"} component={userIsAuthenticated(BannerRoute)} />
                  {/* //?manager system */}
                  <Route path="/system/manager-member" component={MangerMember} />
                  <Route path="/system/manager-config" component={ManagerConfig} />
                  <Route
                    component={() => {
